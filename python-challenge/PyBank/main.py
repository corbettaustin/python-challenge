...
with open(cvspath) as revenueData:
   ...
   for row in reader:
       ...
       #Total
           ...
           totalMonthlyV = int(row["Profit/Losses"])
           totalRevenue = totalRevenue + totalMonthlyV
           revenue_change_list.append(totalMonthlyV)
        



           revenue_change = totalMonthlyV - previousRevenue
           previousRevenue = totalMonthlyV
